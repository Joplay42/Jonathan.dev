            ...
            <div className="h-[70vh] ">
                <section className="grid lg:grid-cols-2 justify-between items-center gap-5 2xl:gap-10 py-4 md:py-14">
                    <div className="order-2 lg:order-1 max-w-5xl">
                        ...
                        <h1 className=" text-3xl 2xl:text-4xl font-semibold leading-9"><span className="text-blue-700">Jonathan</span> Deschênes</h1>
                        <h1 className="text-neutral-600 dark:text-neutral-700 text-3xl 2xl:text-4xl font-bold leading-10">Je suis developper Web</h1>
                        ...
                        <button className="bg-blue-700 hover:bg-transparent hover:text-blue-700 border border-blue-700 dark:bg-blue-700 dark:border-blue-700 dark:hover:text-white hover:dark:bg-transparent text-white px-6 py-3 rounded-lg mt-4">Me contacter</button>
                    </div>
                ...
                <section className="grid lg:grid-cols-2 justify-between items-center gap-5 2xl:gap-10 py-4 md:py-14">
                    <div className="order-2 lg:order-2 max-w-5xl">
                        <h4 className="font-bold text-blue-700 mb-3">À propos</h4>
                        <h1 className=" dark:text-white text-3xl 2xl:text-4xl font-semibold leading-10">Qui <span className="text-blue-700">suis</span>-je?</h1>
                ...
                <section className="grid lg:grid-cols-2 justify-between items-center gap-5 2xl:gap-10 py-4 md:py-14">
                    <div className="order-2 lg:order-1 max-w-5xl">
                        <h4 className="font-bold text-blue-700 mb-3">Expériences</h4>
                ...
                <section className="grid lg:grid-cols-2 justify-between items-center gap-5 2xl:gap-10 py-4 md:py-14">
                    <div className="order-2 lg:order-2 max-w-5xl">
                        <h4 className="font-bold text-blue-700 mb-3">Réalisation</h4>
                        <h1 className=" dark:text-white text-3xl 2xl:text-4xl font-semibold leading-10">Réalisation de <span className="text-blue-700">plusieurs site</span> pour des compagnies</h1>
                        ...
                        <button className="bg-blue-700 hover:bg-transparent hover:text-blue-700 border border-blue-700 dark:bg-blue-700 dark:border-blue-700 dark:hover:text-white hover:dark:bg-transparent text-white px-6 py-3 rounded-lg mt-4">Mes réalisations</button>
                    </div>
