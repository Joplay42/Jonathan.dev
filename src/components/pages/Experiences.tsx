            ...
            <div className="h-[70vh] ">
                <section data-aos="fade-right" className="grid lg:grid-cols-2 justify-between items-center gap-5 2xl:gap-10 py-10 lg:py-20">
                        <div className="order-1 max-w-5xl">
                            ...
                            <p className="mt-6 text-gray-600 font-medium dark:text-neutral-500 leading-6">En tant que développeur web et designer, j'ai acquis une solide expérience dans le domaine. J'ai commencé par utiliser Squarespace, puis j'ai progressé vers HTML, et j'ai même exploré des applications web basées sur des frameworks.</p><br />
                ...
                <section className="grid lg:grid-cols-2 justify-between items-center gap-5 2xl:gap-10 py-10 lg:py-20">
                        <div className="order-1 lg:order-2 max-w-5xl">
                            ...
                            <p className="leading-6 mt-3 text-neutral-600 font-medium dark:text-neutral-400">Avec plus d'un an d'expérience en tant que designer chez la start-up Zorilla web, j'ai accumulé une expérience précieuse, notamment dans la conception de sites web. J'ai eu l'opportunité de réaliser plusieurs sites pour des organismes à but non lucratif, une expérience enrichissante à bien des égards.<br/>Si vous souhaitez découvrir davantage mes réalisations, je vous invite à consulter mes travaux.</p>
                            <a href="https://zorillaweb.com/" target="_blank">
                                <button className="bg-[#FE904D] hover:bg-transparent hover:text-[#FE904D] border border-[#FE904D] dark:bg-[#FE904D] dark:border-[#FE904D] dark:hover:text-white hover:dark:bg-transparent text-white px-6 py-3 rounded-lg mt-4">Voir plus</button>
                            </a>
                        </div>
