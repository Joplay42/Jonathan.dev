...
const SideBar = ({ index, setIndex }: Props) => {
    return (
        <div id="sidebar" className="lg:h-[70vh] hidden xl:block bg-white py-20 lg:py-10 px-4 2xl:px-10 ml-16 mt-6 mr-6 rounded-3xl lg:w-2/5 2xl:w-2/6 relative order-1 shadow-xl border border-gray-200 dark:border-neutral-800 dark:bg-neutral-900">
